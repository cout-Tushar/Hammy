...
export async function reviewApi(request, response) {
    const prompt = `
...
export async function generateDocumentation(request, response) {
...
export async function securityAudit(request, response) {
    const prompt = `
...
export async function explainApi(request, response) {
    const prompt = `
